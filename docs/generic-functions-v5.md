...
Generic signatures remain intact across module boundaries. Typed HIR owns
...
Defensive runtime inference follows the same classification rule introduced by
the runtime-alignment gate: ordinary contradictory evidence is `KS3106`, while
an authority-bearing substitution remains `KS3401`.
