...
def test_two_builders_require_remote_attested_distinct_environments():
    x=chain(); assert x['repro'].builder_a_remote_attestation_evidence_digest==x['remote_a'].evidence_digest; assert x['remote_a'].trust_anchor_manifest_digest==x['manifest_a'].manifest_digest; assert x['remote_a'].trust_anchor_generation==1
