"""Execute bounded-autonomy proposals only through Koschei survival physics v1.
...
from .survival_execution_gate_v1 import (
...
def _require_exact_autonomy_proposal(
    *,
...
def enforce_bounded_autonomy_effect(
    *,
    ...
    """Run no autonomous effect unless the base constitutional chain agrees."""
