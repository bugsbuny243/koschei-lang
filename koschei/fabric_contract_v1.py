    ...
    return (
        ...
        FabricCapabilityV1(
            ...
            notes=(
                ...
                "VALID_PARENT_NOW and execution-time authorization snapshots exist on the integration branch. "
                "This does not close native broker/OS-confinement or T01-T14 acceptance gates."
            ),
        ),
        FabricCapabilityV1(
