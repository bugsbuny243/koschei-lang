...
builder trust-anchor generations are still current today. It is for archival/audit
integrity, not permission to execute a new provider action under current policy.
"""
