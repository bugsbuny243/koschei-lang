...
def _digest(*, effect_envelope: EffectExecutionProofEnvelopeV1,
    ...
    rows = (
        ...
        f"adapter_abi={adapter_abi.abi_digest}",
...
class ExternalFinalityProofEnvelopeV1:
    ...
    def assert_valid(self, *, effect_envelope: EffectExecutionProofEnvelopeV1,
        ...
        expected_fields = (
            ...
            (self.provider_adapter_abi_digest, adapter_abi.abi_digest, "adapter ABI"),
        ...
        for actual, expected, label in expected_fields:
            if actual != expected:
                raise ExternalFinalityProofEnvelopeV1Error(f"external finality proof-envelope {label} mismatch")
