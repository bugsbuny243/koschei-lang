...
receipt. When both builder generation states are external-witness-confirmed, the exact
witness receipt digests are also sealed into provider-native provenance.
"""
